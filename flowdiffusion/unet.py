from guided_diffusion.guided_diffusion.unet import UNetModel, NewUNetModel, UNetModelOriginal
...
class UnetMWOriginal(nn.Module):
    def __init__(self):
        super(UnetMWOriginal, self).__init__()
        self.unet = UNetModelOriginal(
            image_size=(128, 128),
            in_channels=6,
            model_channels=128,
            out_channels=3,
